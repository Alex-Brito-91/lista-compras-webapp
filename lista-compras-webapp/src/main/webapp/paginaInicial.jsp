...
<body>
	<header class="cabecalho">
		<img class="cabecalho-imagem" src="imagens/shopping-basket.png"
			alt="logo do carrinho">
		<nav class="cabecalho-menu">
			<a class="cabecalho-menu-item" href="listaSaldo">Seu Saldo</a> <a
				class="cabecalho-menu-item" href="paginaCadastroTotais">Cadastro
	...
	<main class="conteudo">
		<section class="conteudo-principal">
			...
			<img class="conteudo-principal-imagem" alt="carrinho de compras"
				src="imagens/listbasket2.png">
		</section>
		<section class="conteudo-secundario">
			<h3 class="conteudo-secundario-titulo">O que fazer com a lista?</h3>
			<p class="conteudo-secundario-paragrafo">
				1. Inserir seu <strong>saldo</strong>
			</p>
			<p class="conteudo-secundario-paragrafo">
				2. <strong>Cadastrar</strong> produtos
			</p>
			<p class="conteudo-secundario-paragrafo">
				3. <strong>Ver</strong> lista com produtos
			</p>
			<p class="conteudo-secundario-paragrafo">
				4. <strong>Comparar</strong> seu <strong>saldo</strong> com o <strong>total</strong>
				da compra
			</p>
		</section>
