...
<body>
	<header class="cabecalho-saldo">
		...
		<nav class="cabecalho-menu-saldo">
			...
			<a class="cabecalho-menu-item-saldo" href="paginaCadastroTotais">Cadastro de Produtos</a> 
			...
			<div class="conteudo-principal-div">
				...
				<form class="conteudo-principal-form"action="${linkServletNovoSaldo}" method="post">
					<div class="div-input-alimentacao1">
						<br> Vale Alimentação 1<br>
						<input class="conteudo-principal-input-alimentacao1" type="text" name="vale1" value="0"/><br />
					</div>
					<div class="div-input-alimentacao2">
						<br>Vale Alimentação 2<br>
						<input class="conteudo-principal-input-alimentacao2" type="text" name="vale2" value="0"/><br />
					</div>
